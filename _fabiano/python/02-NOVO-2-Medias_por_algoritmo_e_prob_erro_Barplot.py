...
for prob in probs:
    ...
    if (data.shape[0] > 0):
        ...
        if (gerar_graficos):
            ...
            #salva o gráfico
            plt.savefig('../resultados/graficos-2/comparacao_entre_algoritmos/Barplot_%s.png' % (file_title), bbox_inches='tight', pad_inches=2)  # , format='png', orientation='landscape', papertype='letter')
