...
path_arq_destino = '../02-Estatisticas/interv_confianca_distrib_z/_intervalos_confianca_distrib_Z.txt'
...
for i in range(0, len(colunas)):
    ...
    path_arq_csv_destino = '../02-Estatisticas/interv_confianca_distrib_z/_intervalos_confianca_distrib_Z_%s.csv' %(col_desc)
